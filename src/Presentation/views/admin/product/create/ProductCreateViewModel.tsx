...
const AdminProductCreateViewModal = (category: Category) => {
    ...
    const createProduct = async () => {
        ...
        console.log('PRODUCTO CREAR FORMULARIO' + JSON.stringify(values));
        let files = [];
        files.push(file1!);
        files.push(file2!);
        files.push(file3!);
...
export default AdminProductCreateViewModal;

...
import styles from './ProductUpdateStyles';
import CustomTextInput from '../../../../components/CustomTextInput';
import AdminCategoryCreateViewModal from './ProductUpdateViewModel';
import RoundedButton from '../../../../components/RoundedButton';
import { StackScreenProps } from '@react-navigation/stack';
import { MyColors } from '../../../../theme/AppTheme';
import { ProductStackParamList } from '../../../../navigator/AdminProductNavigator';
import ModalPickMultipleImage from '../../../../components/ModalPickMultipleImage';
import AdminProductUpdateViewModal from './ProductUpdateViewModel';
...
export const AdminProductUpdateScreen = ({ navigation, route }: Props) => {
  ...
  const { name, description, image1, image2, image3, price, takePhoto, pickImage, updateProduct, responseMesage, loading, onChange } = AdminProductUpdateViewModal(product, category);
